        ...
        <section className="mb-32 text-center">
          ...
          <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
            <div className="mb-12 md:mb-0">
              ...
              <h5 className="mb-2 text-lg font-bold">Jesmin Begum</h5>
            ...
            <div className="mb-12 md:mb-0">
              ...
              <h5 className="mb-2 text-lg font-bold">Mowmita Akter</h5>
            ...
            <div className="mb-0">
              ...
              <h5 className="mb-2 text-lg font-bold">Sagor Smith</h5>
              <p className="mb-4">
